...
public class UUIDManager {
	...
	// This is used to see if the cached UUID was older than 12 hours. If it is
	// older than 12 hours,
	// it will be renewed.
	...
	public static Map<String, UUID> getUUIDs(final List<String> names) {
		...
		// We have to make sure we only lookup the players that we haven't got
		// cached values of yet.
